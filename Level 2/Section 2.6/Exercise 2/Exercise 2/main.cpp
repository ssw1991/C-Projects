...
std::tuple<std::string, int, std::string> GetInfo(std::error_condition e)
{
...
int main()
{
	...
	std::error_condition e3(std::errc::permission_denied);
	...
	std::cout << "E3 message: " << e3message << " E3 value: " << e3val << " E1 Cat: " << e3cat;
}
